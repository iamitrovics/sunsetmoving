...
function wtp_cities() {
	...
	$args = array(
		...
		'publicly_queryable'    => true,
		'capability_type'       => 'page',
		'rewrite' => array('slug' => 'international-moving-services','with_front' => false),
...
function wtp_countries() {
	...
	$labels = array(
		...
		'name_admin_bar'        => __( 'Edit Countries', 'text_domain' ),
		'archives'              => __( 'Аrchive', 'text_domain' ),
		'parent_item_colon'     => __( 'Parent Item:', 'text_domain' ),
	...
	$args = array(
		...
		'description'           => __( 'Countries', 'text_domain' ),
		'labels'                => $labels,
		'supports'              => array( 'title'),
		'hierarchical'          => false,
		'public'                => true,
...
add_action( 'init', 'wtp_countries', 0 );
